...
import { getPullJobLight, getLatestUnfinishedPullJob } from '@/modules/google-sheet-products-for-shop/lib/pull-job'
...
export async function GET(req: NextRequest) {
  ...
  const job = id ? await getPullJobLight(id) : await getLatestUnfinishedPullJob()
